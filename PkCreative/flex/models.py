...
class FlexPage(Page):
    ...
    titletwo = models.CharField(max_length=100, null=True, blank=True)
...
class ServicePage(Page):
    ...
    template = "flex/service_page.html"
...
class PortfolioPage(Page):
    ...
    template = "flex/portfolio_page.html"
